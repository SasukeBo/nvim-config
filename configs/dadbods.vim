...
let g:dadbods = []
let db = {
			\"name": "Dev Postgres Account",
			\"url": "postgresql://thingbobo:ZI9NhYcqloytCp&@postgres.thingyouwe.com:32432/account",
			\}
call add(g:dadbods, db)
let db = {
			\"name": "Dev Postgres Auth",
			\"url": "postgresql://thingbobo:ZI9NhYcqloytCp&@postgres.thingyouwe.com:32432/auth",
			\}
call add(g:dadbods, db)
